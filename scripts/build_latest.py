...
GENRE_GROUPS = [
    ...
    {"name": "都市生活", "categories": ["都市日常", "都市种田", "都市脑洞"]},
    {"name": "都市异能", "categories": ["都市高武", "都市修真", "战神赘婿"]},
...
MARKET_KEYWORDS = [
    "重生", "穿越", "系统", "签到", "开局", "无敌", "苟道", "长生", "反派", "退婚",
    "修仙", "修真", "炼体", "武道", "高武", "灵气复苏", "觉醒", "天赋", "剑修", "宗门",
    "御兽", "召唤", "洪荒", "神话", "诸天", "万界", "无限流", "副本", "轮回",
    "末世", "丧尸", "废土", "星际", "机甲", "国运", "科技", "工业", "基建",
    "三国", "大唐", "大明", "权谋", "争霸", "谍战", "抗战", "特工", "兵王",
    "战神", "赘婿", "神医", "透视", "鉴宝", "收租", "摆烂", "扮猪吃虎", "打脸",
    "直播", "网游", "电竞", "卡牌", "足球", "篮球", "综漫", "美食", "钓鱼",
    "盗墓", "灵异", "民俗", "阴阳", "刑侦", "推理", "商战", "学霸", "家族",
]
